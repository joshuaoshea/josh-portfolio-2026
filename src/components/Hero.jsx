...
const Hero = () => {
  ...
  return (
    <section id="about" className="pt-[120px] md:pt-[140px] pb-0 md:pb-[calc(40vh-310px)] lg:pb-[calc(45vh-310px)] px-6 md:px-12 lg:px-[50px] relative z-10">
      <div className="max-w-[1390px] mx-auto pb-20">
        {/* Main Intro */}
        <div className="flex flex-col gap-2 max-w-full md:max-w-[751px] lg:max-w-[1037px]">
          ...
          <a 
            ...
            className="group inline-flex items-center gap-[5px] mt-8 text-black hover:text-[#CE5347] text-[20px] md:text-[32px] lg:text-[48px] font-normal font-manrope cursor-pointer w-fit transition-colors"
          >
            <span className="relative">
              Learn more
              <span className="absolute bottom-0 left-0 w-0 h-[1px] transition-all duration-300 group-hover:w-full bg-black group-hover:bg-[#CE5347]"></span>
            </span>
            <svg 
              className="w-5 h-[22px] md:w-7 md:h-[30px] lg:w-8 lg:h-[34px] text-black group-hover:text-[#CE5347] transition-all duration-300 translate-y-1 group-hover:-rotate-45 group-hover:-translate-y-0.5" 
              viewBox="0 0 14 15" 
              fill="none" 
